								...
								<div className="col-lg-8 col-md-7 mb-30 mb-md-50">
									<form className="booking-form">
										<div className="row">
												...
												<div className="form-group">
													...
													<div className="input-group">
														<select className="form-control">
															...
															<option defaultValue="General Motors">General Motors</option>
															<option defaultValue="Land Rover">Land Rover</option>
															<option defaultValue="Lexus">Lexus</option>
															<option defaultValue="Lincoln">Lincoln</option>
															<option defaultValue="Mazda">Mazda</option>
															<option defaultValue="Mercury">Mercury</option>
															<option defaultValue="Nissan">Nissan</option>
															<option defaultValue="Renault">Renault</option>
															<option defaultValue="Plymouth">Plymouth</option>
															<option defaultValue="Rover">Rover</option>
													...
													<div className="row">
														<div className="col-md-12 col-lg-4">
															<div className="form-check custom-checkbox mb-10">
																...
																<label className="form-check-label" htmlFor="customControlAutosizing1">Air Conditioning</label>
															</div>
														</div>
														<div className="col-md-12 col-lg-4">
															<div className="form-check custom-checkbox mb-10">
																<input type="checkbox" className="form-check-input" id="customControlAutosizing2"/>
																<label className="form-check-label" htmlFor="customControlAutosizing2">Brakes Repair</label>
															</div>
														</div>
														<div className="col-md-12 col-lg-4">
															<div className="form-check custom-checkbox mb-10">
																<input type="checkbox" className="form-check-input" id="customControlAutosizing3"/>
																<label className="form-check-label" htmlFor="customControlAutosizing3">Engine Diagnostics</label>
															</div>
														</div>
														<div className="col-md-12 col-lg-4">
															<div className="form-check custom-checkbox mb-10">
																<input type="checkbox" className="form-check-input" id="customControlAutosizing4"/>
																<label className="form-check-label" htmlFor="customControlAutosizing4">Heating &amp; Cooling</label>
															</div>
														</div>
														<div className="col-md-12 col-lg-4">
															<div className="form-check custom-checkbox mb-10">
																<input type="checkbox" className="form-check-input" id="customControlAutosizing5"/>
																<label className="form-check-label" htmlFor="customControlAutosizing5">Oil, Lube &amp; Filters</label>
															</div>
														</div>
														<div className="col-md-12 col-lg-4">
															<div className="form-check custom-checkbox mb-10">
																<input type="checkbox" className="form-check-input" id="customControlAutosizing6"/>
																<label className="form-check-label" htmlFor="customControlAutosizing6">Transmission Repair</label>
															</div>
														</div>
													</div>										
												</div>										
											...
											<div className="col-lg-12">
												<button name="submit" type="submit" defaultValue="Submit" className="btn btn-primary btn-lg"> Send Message</button>
											</div>
										</div>
									</form>
								</div>
